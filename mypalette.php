          ...
          <form class="col s12" method="post" action=loginsession.php>
            ...
            <div class='row'>
              <div class='input-field col s12'>
                <h6 class='form1' float='left'><strong>Enter your ID</strong></h6>
                <input class="u-full-width" name="id" type="text" placeholder="ID" id="id">
            ...
            <div class='row'>
              <div class='input-field col s12'>
                <h6 class='form1'><strong>Enter your Password</strong></h6>
                <input class="u-full-width" name = "password" type="text" placeholder="password" id="password">
