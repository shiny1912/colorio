...
<div><a href="logout.php" style="float:right"><h6>Logout</h6></a> 
</div>
...
<div class="container">
<div class="col s1" style="background-color:#eeeeee;color:#aaaaaa;margin:20px">
 <h6>Click search bar and pick color you want, or type in any color in hex ex)fffff. Please exclude '#'!  </h6>
</div>
<form class="col s6"  id="myForm" action="" method="post">

    <div class="input-field col s3">
        <input class="jscolor col s6" value="ab2567" type="text" id="item" name="imageSearch" >
        
        
             <!--  <input class = 'btn tooltipped' id="search" type="submit" value="search" data-position="bottom" data-delay="30" data-tooltip="please refresh!"></input> -->
